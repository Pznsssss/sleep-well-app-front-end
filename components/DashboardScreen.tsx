  ...
  const fetchData = async () => {
    try {
      ...
      setSensor({
        ...
        soundLevel: Number(latest.sound_level) || 0,
        lightLevel: Number(latest.light_level) || 0,
        motionLevel: Number(latest.movement_count) || 0,
      });
      ...
      setChartData((prev) => {
        ...
        return {
          ...
          labels: newLabels.length > maxLength ? newLabels.slice(1) : newLabels,
        };
      });
      ...
      setError(e.message || "Failed to fetch sensor data.");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
    ...
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      >
        ...
        <Text style={styles.subHeader}>
          Real-time environmental monitoring for optimal health
        </Text>
        ...
        {loading ? (
          ...
          <>
            <View style={styles.cardsRow}>
              <View style={styles.card}>
                <View style={styles.row}>
                  <FontAwesome5 name="bed" size={18} color="#fff" style={styles.icon} />
              ...
              <View style={styles.card}>
                <View style={styles.row}>
                  <MaterialCommunityIcons name="thermometer" size={18} color="#fff" style={styles.icon} />
                  <Text style={styles.title}>Temperature</Text>
                </View>
                <Text style={styles.value}>{sensor.temperature}°C</Text>
                <View style={[styles.badge, {
                  backgroundColor: sensor.temperature >= 18 && sensor.temperature <= 22
                    ? "#10B981"
                    : "#EF4444"
                }]}>
            ...
            <View style={styles.cardsRow}>
              <View style={styles.card}>
                <View style={styles.row}>
                  <MaterialIcons name="volume-up" size={18} color="#fff" style={styles.icon} />
              ...
              <View style={styles.card}>
                <View style={styles.row}>
                  <MaterialCommunityIcons name="weather-night" size={18} color="#fff" style={styles.icon} />
            ...
            <View style={styles.cardsRow}>
              <View style={styles.card}>
                <View style={styles.row}>
                  <MaterialIcons name="directions-run" size={18} color="#fff" style={styles.icon} />
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 26, fontWeight: "bold", color: "#fff", marginBottom: 4, marginTop: 8 },
  ...
  card: {
    width: CARD_WIDTH, backgroundColor: "rgba(44, 62, 120, 0.85)", borderRadius: 14,
    padding: 14, marginHorizontal: 4, alignItems: "flex-start", shadowColor: "#000",
    shadowOpacity: 0.1, shadowRadius: 8, elevation: 3,
  },
  row: { flexDirection: "row", alignItems: "center", marginBottom: 6 },
  icon: { marginRight: 6 },
  title: { color: "#fff", fontSize: 15, fontWeight: "bold" },
  value: { color: "#fff", fontSize: 22, fontWeight: "bold", marginBottom: 6, marginTop: 4 },
  badge: { borderRadius: 12, paddingVertical: 2, paddingHorizontal: 10, alignSelf: "flex-start" },
  badgeText: { color: "#fff", fontWeight: "bold", fontSize: 12 },
  section: {
    backgroundColor: "rgba(44, 62, 120, 0.85)", borderRadius: 14,
    padding: 16, marginBottom: 16, marginHorizontal: 4,
  },
  sectionTitle: { color: "#fff", fontSize: 17, fontWeight: "bold", marginBottom: 10 },
  errorContainer: {
    backgroundColor: 'rgba(220, 38, 38, 0.2)', padding: 16,
